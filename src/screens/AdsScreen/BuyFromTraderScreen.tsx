...
export default function BuyFromTraderScreen() {
    ...
    const handleCreateOrder = async () => {
        ...
        setLoading(true);
        try {
            const resp = await escrowApi.buyEscrow({
                adID: adId,
                volumToBuy: finalGbp,
                rate: rate,
    ...
    return (
        <SafeAreaView style={s.root}>
            <View style={s.header}>
                ...
                <Text style={s.headerTitle}>Buy GBP</Text>
            </View>
            ...
            <ScrollView style={s.body} keyboardShouldPersistTaps="handled">
                ...
                <View style={s.inputCard}>
                    <Text style={s.label}>I want to buy (GBP)</Text>
                ...
                <View style={s.summaryCard}>
                    ...
                    <View style={s.summaryRow}>
                        <Text style={s.summaryLbl}>Seller Receives</Text>
                        <Text style={s.summaryVal}>₦{feeCalc ? feeCalc.estimatedPayout.toLocaleString() : ngnAmount.toLocaleString()}</Text>
                    </View>
                    <View style={[s.summaryRow, s.totalRow]}>
                        <Text style={s.totalLbl}>Total to Pay</Text>
                        <Text style={s.totalVal}>₦{ngnAmount.toLocaleString()}</Text>
                    </View>
                ...
                <View style={s.secureNote}>
                    ...
                    <Text style={s.secureTxt}>Your funds are protected by EscrowITX until you receive the GBP.</Text>
                </View>
...
const s = StyleSheet.create({
    ...
    rateBadge: { backgroundColor: '#EEF2FF', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6, alignSelf: 'flex-start' },
    rateTxt: { color: colors.blue, fontWeight: '600', fontSize: 12 },
    ...
    totalVal: { fontSize: 18, fontWeight: '800', color: colors.blue },
